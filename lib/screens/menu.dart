...
import 'package:sugeng_avenue/widgets/product_card.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  final List<ItemHomepage> items = [
      ItemHomepage("Lihat Daftar Product", Icons.list, const Color.fromARGB(230, 19, 125, 187)),
      ItemHomepage("Tambah Product", Icons.add, const Color.fromARGB(255, 221, 190, 50)),
